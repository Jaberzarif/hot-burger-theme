...
if (!function_exists('hot_burger_cart_link')) {

    function hot_burger_cart_link() {
        ?>	
...
if (!function_exists('hot_burger_header_cart')) {

    function hot_burger_header_cart() {
        if (get_theme_mod('woo_header_cart', 1) == 1) {
            ?>
            <div class="header-cart">
                <div class="header-cart-block">
                    <div class="header-cart-inner">
                        <?php hot_burger_cart_link(); ?>
...
if (!function_exists('hot_burger_header_add_to_cart_fragment')) {
    add_filter('woocommerce_add_to_cart_fragments', 'hot_burger_header_add_to_cart_fragment');

    function hot_burger_header_add_to_cart_fragment($fragments) {
        ob_start();

        hot_burger_cart_link();
...
if (!function_exists('hot_burger_my_account')) {

    function hot_burger_my_account() {
